...
def create_acc_commands(packer, enabled, active, latActive, accel, gas, idx, stopping, car_fingerprint):
  commands = []
  bus = get_pt_bus(car_fingerprint)
  ...
  standstill_release = 1 if (active or latActive) and not stopping else 0
